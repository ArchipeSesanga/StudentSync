    ...
    public class DBInitializerRepo : IDBInitializer
    {
        public void Initialize(ApplicationDbContext context)
        {
            ...
            if (!context.Students.Any())
            {
                ...
                {
                    new Student { StudentNumber = "2021000001", FirstName = "Liam", Surname = "Peters", EnrollmentDate = DateTime.Parse("2021-02-03") ,Photo = "Default.png", Email = "DefaultEmail@gmail.com" },
                    new Student { StudentNumber = "2012000002", FirstName = "Sophia", Surname = "Green", EnrollmentDate = DateTime.Parse("2021-02-01"),Photo = "Default.png", Email = "DefaultEmail@gmail.com" },
                    new Student { StudentNumber = "2021000003", FirstName = "Noah", Surname = "Kim", EnrollmentDate = DateTime.Parse("2021-02-04"),Photo = "Default.png", Email = "DefaultEmail@gmail.com" }
                };
